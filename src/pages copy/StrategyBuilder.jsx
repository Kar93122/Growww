          ...
          <div className="card" style={{padding:12}}>
            ...
            <ResponsiveContainer width="100%" height={160}>
              <AreaChart data={chartData}>
                ...
                <Area type="monotone" dataKey="price" stroke="#6c63ff" fill="url(#priceGrad)" strokeWidth={1.5} dot={false} />
                {mainIndicators.map(ind=>(
                  <Line key={ind.id} type="monotone" dataKey={ind.id} stroke={ind.color} strokeWidth={1} dot={false} />
                ))}
              </AreaChart>
            </ResponsiveContainer>
          </div>
            ...
            <div className="card" style={{padding:16}}>
              ...
              <ResponsiveContainer width="100%" height={200}>
                <AreaChart data={chartData}>
                  ...
                  <Area type="monotone" dataKey="price" stroke="#6c63ff" fill="url(#btGrad)" strokeWidth={1.5} dot={false} />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          )}
              ...
              <div className="card" style={{padding:12}}>
                ...
                <ResponsiveContainer width="100%" height={150}>
                  <AreaChart data={backtestResult.equityCurve.filter((_,i)=>i%3===0)}>
                    ...
                    <Area type="monotone" dataKey="value" stroke={backtestResult.totalReturn>=0?'#00d084':'#ff4757'} fill="url(#eqGrad)" strokeWidth={2} dot={false} />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
            </div>
