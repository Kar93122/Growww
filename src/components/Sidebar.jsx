...
const NAV_ITEMS = [
  {
    ...
    items: [
      ...
      { path: '/markets', icon: TrendingIcon, label: 'Markets' },
      { path: '/watchlist', icon: StarIcon, label: 'Watchlist' },
    ],
  },
  {
    section: 'Trading',
    items: [
      { path: '/simulator', icon: BriefcaseIcon, label: 'Simulator' },
      { path: '/trades', icon: ClipboardIcon, label: 'Trade History' },
    ],
  },
  {
    section: 'Analytics',
  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-logo">
        ...
        <span className="sidebar-logo-text">Gr<em>o</em>ww</span>
      </div>
